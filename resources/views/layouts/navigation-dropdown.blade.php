<header class="z-10 py-2 top-0 sticky bg-gradient-to-r from-purple-500 to-purple-400">
    <div class="container flex items-center justify-between h-full px-6  text-purple-600 dark:text-purple-300">
        ...
        <div class="flex">
            ...
            @endif
            <span class="font-bold text-white font-sans pt-3 pl-1 uppercase tracking-wider">sales and inventory</span>
        </div>
