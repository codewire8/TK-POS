<header class="z-10 py-4 bg-purple-500 shadow-md dark:bg-gray-800">
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative">
                ...
                <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-indigo"
                    @click="toggleNotificationsMenu" @keydown.escape="closeNotificationsMenu" aria-label="Notifications"
                    aria-haspopup="true">
                    <svg class="w-6 h-6 text-purple-700" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                        <path
