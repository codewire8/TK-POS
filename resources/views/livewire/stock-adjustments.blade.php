    ...
    <div class="flex flex-col">
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow border-b rounded-md border-gray-200 h-72 overflow-auto">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <div class="grid grid-cols-6 gap-6 py-2">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <x-jet-input id="user" value="{{ Auth::user()->name }}"
                                        class="block mt-1 w-full bg-gray-100" type="text" disabled />
                                </div>
                            </div>
                            <div class="grid grid-cols-6 gap-6 py-2">
                                <div class="col-span-6 sm:col-span-3">
