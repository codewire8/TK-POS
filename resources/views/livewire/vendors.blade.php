    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            <div class="mt-4">
                ...
                @if ($modelId)
                <x-jet-input id="name" class="block mt-1 w-full" type="text" wire:model="name" wire:keydown.enter="update" />
                @else
                <x-jet-input id="name" class="block mt-1 w-full" type="text" wire:model="name" wire:keydown.enter="create" />
                @endif
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="contact_person_telno" class="block mt-1 w-full" type="text" wire:model="contact_person_telno" />
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="contact_person_email" class="block mt-1 w-full" type="text" wire:model="contact_person_email" />
