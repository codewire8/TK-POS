                ...
                <div class="px-4 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            @if (!is_null($vendors))
                            <select wire:model="vendorId" wire:change.debounce.500ms="getVendorDetails" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block mt-1 w-full {{ $errors->has('vendorId') ? 'border-red-300' : '' }}">
                                <option value="">---</option>
                    ...
                    <div class="grid grid-cols-6 gap-6 pt-2">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <x-jet-input class="block mt-1 w-full {{ $errors->has('stock_in_by') ? 'border-red-300' : '' }}" type="text" wire:model.debounce.500ms="stock_in_by" />
                    ...
                    <div class="grid grid-cols-6 gap-6 pt-2">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <x-jet-date-input class="block mt-1 w-full" wire:model.debounce.500ms="stock_in_date" type="text" />
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-600">
                                    <tr>
                                        ...
                                        <th scope="col" class="py-2 text-center text-xs font-medium text-white uppercase tracking-wider">
                                            qty
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-0 whitespace-nowrap text-center text-sm text-gray-500 font-medium">
                                            ...
                                            <div class="flex item-center justify-center">
                                                ...
                                                <svg wire:click.prevent="decrement({{ $item['pId'] }})" class="h-5 w-5 mr-1 mt-2 cursor-pointer transform rotate-180 fill-current text-green-400" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
                                                </svg>

                                                <input type="text" wire:model.defer="items.{{ $key }}.qty" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 text-center focus:ring-opacity-50 text-xs rounded-md shadow-sm w-16" value="{{ $item['qty']}}" type="text">

                                                <svg wire:click.prevent="increment({{ $item['pId'] }})" class="h-5 w-5 ml-1 mt-2 cursor-pointer fill-current text-green-400" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
                                                </svg>
                                        ...
                                        <td class="px-6 py-2 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex item-center justify-end">
                                                <div wire:click="removeSelectedItem({{ $key }})" class="w-4 mr-2 text-gray-500 transform hover:text-purple-500 hover:scale-110 cursor-pointer">
        ...
        <x-slot name="title">
            <div class="grid grid-cols-2">
                ...
                <div class="relative flex justify-end">
                    <div class="md:mt-0">
                        <input type="text" class="bg-white rounded-2xl w-72 px-4 pl-8 py-1 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border-gray-300 focus:border-indigo-300" wire:model.debounce.500ms="query" x-ref="query" @keydown.window="
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-2 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex item-center justify-end">
                                                <div wire:click="addSelectedItem({{ $item->id }})" class="w-4 mr-2 text-gray-500 transform hover:text-purple-500 hover:scale-110 cursor-pointer">
                                                    <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
